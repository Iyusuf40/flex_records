...
export default function Tutorial() {
  return (
	...
	the results of the computation will be stored there. <br /><br />
	<strong>NOTE:</strong> for basic rules, you can only store 
	...
	clicking on <em>clear rule</em> button. Then you can apply the rules back
	...
	<p>
		  ...
		  <h3>subtract:</h3>
		   ...
		   <br />
		   <b>NOTE:</b> Basic rules only checks the first and second column
		   ...
		   <br />
		   <b>For Calculation accross rows:</b> Gets the data in the first
		   ...
		   <br />
		   <b>NOTE:</b> Basic rules only checks the first and second row
	           for numeric data. If your table is structured in such a way
	           that the numeric fields are deep in the table we suggest you
                   use advanced instead as it gives you the chance to choose
		  ...
		  <h3>multiply:</h3>
		   <b>For Calculation accross columns:</b> multiplies all 
	           numeric data 
	           accross all columns and stores the result on the last column. 
		   <br />
		  ...
		  <h3>average:</h3>
		   ...
		   <br />
		   <b>For Calculation accross rows:</b> sums all numeric data
	           accross all rows; 
	           divides the sum by the number of cells where numeric data was
	           found
	...
	<h2>Advanced Rules</h2>
		...
		columns 1 through 3 and save the result in column 5. <br />
	...
	<p>
		  ...
		  <h3>subtract:</h3>
		   <b>For Calculation accross columns:</b> Gets the data of the 
	           first column
		   ...
		   <br />
		   <b>For Calculation accross rows:</b> Gets the data of the first
		  ...
		  <h3>subtract reverse:</h3>
		   ...
		   <br />
		   <b>For Calculation accross rows:</b> Gets the data in the row of
	...
	<div className="features">
		...
		<p>
		  <b>switch user:</b> This button enables users to switch accounts
		  by giving an input field to insert user's ID.
		  <br />
		  <b>create table:</b> On clicking this button you'd be given
		  ...
		  option to enter the size of the table in the format row x column
	 	  i.e. number of rows and number of columns you want the table to
	          have.
	          <br />
		  <b>modify table:</b> You can change the name of the current table
		  by clicking this button. To delete a table, type in 'delete'
		  in the input field spawned by clicking this button.
		  <br />
		  <b>add column, del column:</b> These buttons give you the chance
		  to add new columns to your table or remove them.
		  <br />
		  <b>add row, del row:</b> These buttons give you the chance
	 	  to add new rows to your table or remove them.
		  <br />
		  <b>add rule, advanced:</b> These buttons allow you add
		  basic and advanced rules to your table respectively.
		  <br />
		  <b>clear rule:</b> This button allows you to remove rule
