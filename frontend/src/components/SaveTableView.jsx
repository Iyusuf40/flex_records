...
export default function TableView(props) {
  ...
  const noOfRows = currentTable
    ...
    : null;
  const table = currentTable ? props.records.tables[currentTable] : {};
  ...
  return (
    <div className="table--view">
      <div className="rules--buttons">
        <button onClick={(e) => props.addColumn(currentTable)}>
          add column +
        </button>
        <button onClick={(e) => props.delColumn(currentTable)}>
          del column -
        </button>
        <button onClick={(e) => props.addRow(currentTable)}>add row +</button>
        <button onClick={(e) => props.delRow(currentTable)}>del row -</button>
        <button onClick={(e) => props.addRule(currentTable)}>add rule +</button>
      </div>
      {table.ruleMode ? (
      ...
      <div className="current--table">{tableView}</div>
    </div>
  );
}
